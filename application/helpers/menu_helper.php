...
function app_init_admin_sidebar_menu_items()
{
    ...
    $CI->app_menu->add_sidebar_menu_item('bookings', [
        'name'     => 'Booking',
       // 'href'     => admin_url('projects'),			// change by sourav
        'icon'     => 'fa-solid fa-chart-gantt',
        'position' => 30,
        'badge'    => [],
    ]);					$CI->app_menu->add_sidebar_children_item('bookings', [			//add by sourav            'slug'     => 'bookings_trips',            'name'     => 'Trip Booking',            'href'     => admin_url('trips'),            'position' => 2        ]);			$CI->app_menu->add_sidebar_children_item('bookings', [			//add by sourav            'slug'     => 'bookings_Train',            'name'     => 'Train Booking',            'href'     => admin_url('projects'),            'position' => 3        ]);			$CI->app_menu->add_sidebar_children_item('bookings', [			//add by sourav            'slug'     => 'bookings_Flight',            'name'     => 'Flight Booking',            'href'     => admin_url('projects'),            'position' => 4        ]);			$CI->app_menu->add_sidebar_children_item('bookings', [			//add by sourav            'slug'     => 'bookings_Hotel',            'name'     => 'Hotel Booking',            'href'     => admin_url('projects'),            'position' => 5        ]);			$CI->app_menu->add_sidebar_children_item('bookings', [			//add by sourav            'slug'     => 'bookings_Car',            'name'     => 'Car Booking',            'href'     => admin_url('projects'),            'position' => 6        ]);			$CI->app_menu->add_sidebar_children_item('bookings', [			//add by sourav            'slug'     => 'bookings_Extra',            'name'     => 'Extra Booking',            'href'     => admin_url('projects'),            'position' => 7        ]);
	$CI->app_menu->add_sidebar_menu_item('masters', [				//add by sourav        'name'     => 'Master Data',        'icon'     => 'fa-solid fa-chart-gantt',        'position' => 40,        'badge'    => [],    ]);		$CI->app_menu->add_sidebar_children_item('masters', [			//add by sourav		'slug'     => 'masters_package',		'name'     => 'Packages',		'href'     => admin_url('packages'),		'position' => 1	]);		$CI->app_menu->add_sidebar_children_item('masters', [			//add by sourav		'slug'     => 'masters_hotel',		'name'     => 'Hotels',		'href'     => admin_url('packages/hotel'),		'position' => 1	]);		$CI->app_menu->add_sidebar_children_item('masters', [			//add by sourav		'slug'     => 'masters_transport',		'name'     => 'Transport',		'href'     => admin_url('packages/transport'),		'position' => 1	]);		$CI->app_menu->add_sidebar_children_item('masters', [			//add by sourav		'slug'     => 'masters_location',		'name'     => 'Location',		'href'     => admin_url('packages/location'),		'position' => 1	]);		
