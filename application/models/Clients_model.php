...

{
...

    {
		...
		$data['permissions'] = array(1,2,3);  //add by sourav
        ...
        if ($client_request == false) {
            ...
            $data['estimate_emails']    = 0; //isset($data['estimate_emails']) ? 1 :0;      //Change by sourav      

            $data['task_emails']        = 0; //isset($data['task_emails']) ? 1 :0;		//add by sourav

            $data['project_emails']     = 0; //isset($data['project_emails']) ? 1 :0;		//add by sourav

            $data['ticket_emails']      = 0; //isset($data['ticket_emails']) ? 1 :0;		//add by sourav
