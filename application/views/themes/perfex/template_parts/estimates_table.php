...
<table class="table dt-table table-estimates" data-order-col="1" data-order-type="desc">
    ...
    <tbody>
        <?php foreach($estimates as $estimate){ ?>
            <tr>
                <td data-order="<?php echo e($estimate['number']); ?>"><a href="<?php echo site_url('estimate/' . $estimate['id'] . '/' . $estimate['hash']); ?>" class="estimate-number"><?php echo e(format_estimate_number($estimate['id'])); ?></a>
                    <?php
                ...
                <td data-order="<?php echo e($estimate['date']); ?>"><?php echo e(_d($estimate['date'])); ?></td>
                <td data-order="<?php echo e($estimate['expirydate']); ?>"><?php echo e(_d($estimate['expirydate'])); ?></td>
                <td data-order="<?php echo e($estimate['total']); ?>"><?php echo e(app_format_money($estimate['total'], $estimate['currency_name'])); ?></td>
                <td><?php echo e($estimate['reference_no']); ?></td>
