            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="_buttons tw-mb-2 sm:tw-mb-4">
                        ...
                        <a href="<?php echo admin_url('trips/addtrip'); ?>"
                            class="btn btn-primary pull-left display-block mright5">
                            <i class="fa-regular fa-plus tw-mr-1"></i>
                            <?php echo 'New Trip Name'; ?>
                        </a>
                        <?php } ?>
                        	...
                        	<div class="row mbot15">
                              <div class="col-md-12">
                                <h4 class="tw-mt-0 tw-font-semibold tw-text-lg tw-flex tw-items-center"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="tw-w-5 tw-h-5 tw-text-neutral-500 tw-mr-1.5">
                                  ...
                                  </svg><span> All Trips Name</span></h4>
                              </div>  
                            </div>                         
                            <hr class="hr-panel-separator" />
                            <div class="panel-table-full">
                                <?php $this->load->view('admin/trips/table_html'); ?>
                            </div>
                        </div>
                    </div>
                </div>
...
$(function() {	
    ...
    initDataTable('.table-all-trip', admin_url + 'trips/table', optionsHeading, optionsHeading, allContactsServerParams, [0, 'asc'] );
