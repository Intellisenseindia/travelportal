                ...
                <div class="row">
                    ...
                    <div class="col-md-<?php echo !isset($client) ? 12 : 8; ?>">
                      ...
                      echo render_input('vat', 'client_vat_number', $value);
                        ...
                        <?php if ((isset($client) && empty($client->email)) || !isset($client)) {
                      $value = (isset($client) ? $client->email : '');
                      echo render_input('email', 'client_email', $value);
                  } else { ?>
                        <div class="form-group">
                            <label for="email"><?php echo _l('client_email'); ?></label>							<input type="text" name="email" id="email" class="form-control" value="<?php echo e($client->email); ?>">
                            <!-- Change by sourav -->
                        </div>
                        <?php }
                     $selected = [];
                        ...
                        (total_rows(db_prefix() . 'invoices', ['clientid' => $client->userid]) > 0 || total_rows(db_prefix() . 'estimates', ['clientid' => $client->userid]) > 0 || total_rows(db_prefix() . 'creditnotes', ['clientid' => $client->userid]) > 0)) { ?>
                            <div class="col-md-12">
                                <div class="alert alert-warning">
                                    <div class="checkbox checkbox-default -tw-mb-0.5 hide">
                                        <input type="checkbox" checked name="update_all_other_transactions"
                                    ...
                                    <p class="tw-ml-7 tw-mb-0 hide">
                                        <?php echo _l('customer_update_address_info_on_invoices_help'); ?>
                                    </p>
                                    <div class="checkbox checkbox-default hide">
                                        <input type="checkbox" checked name="update_credit_notes" id="update_credit_notes">
