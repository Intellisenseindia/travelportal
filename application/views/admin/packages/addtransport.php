                    ...
                    <div class="panel-body">                         
                        <div>
                            <div class="tab-content">
								...
								<div class="col-md-12">	
								  <div class="form-group" app-field-wrapper="transport_name">										
									<label for="transport_name" class="control-label">Agency / Individual Name</label>										
									<input type="text" id="transport_name" name="transport_name" class="form-control" value="<?php echo $transport_name; ?>">
                                  </div>
								  <?php

										$types[]                = array('type_value'=>'Agency','type_name'=>'Agency');
										$types[]                = array('type_value'=>'Individual','type_name'=>'Individual');			
										$typeselected = $type_selected;
										echo render_select('transport_type', $types, [ 'type_value', [ 'type_name']], 'Transport type', $type_selected, ['data-none-selected-text' => _l('dropdown_non_selected_tex')]);
								  ...
								  <div class="form-group" app-field-wrapper="map">										
									<label for="map" class="control-label">Vehicle Type</label>										
									<?php
										...
										{
											$che = (in_array($vehicle['vaicle_id'], $selectedvaicle))? 'checked=""' : '';
											$vehicle_check_box .= '<div class="checkbox"><input type="checkbox" name="vehicles[]" value="' . $vehicle['vaicle_id'] . '" ' . $che . ' ><label>' . $vehicle['vaicle_name'] . '</label></div>';
										}
										echo $vehicle_check_box;
									?>
                                  </div>
