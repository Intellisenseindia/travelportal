...
<div id="sales-notes-wrapper" data-total="<?php echo e($len); ?>">
    ...
    <div class="media sales-note-wrapper">
        ...
        <div class="media-body">
            ...
            <div data-note-description="<?php echo e($note['id']); ?>" class="text-muted mtop10 tw-whitespace-pre-wrap"><?php echo process_text_content_for_display($note['description']); ?></div>
